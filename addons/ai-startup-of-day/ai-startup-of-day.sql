-- AI Startup of the Day — reference registration + schema (mirrored from the ilm.red monorepo).
...
VALUES (
  'ai-startup-of-day', 'AI Startup of the Day', '1.0.0', 'A notable AI company or lab each day, with a neutral, factual note on what they build. Curated catalogue, refreshed daily.', '🚀',
  'ILM Red Unbound', 'Apache-2.0', 'AiStartupOfDayAddon', 'engagement', ARRAY[]::text[],
  '{}'::jsonb, false, true, true, 'published', 'Shows one item a day from a curated, human-written catalogue of AI companies/labs. Notes are evergreen and factual. No personal data is collected.')
