-- Mathematician of the Day — reference registration + schema (mirrored from the ilm.red monorepo).
...
VALUES (
  'mathematician-of-day', 'Mathematician of the Day', '1.0.0', 'A historical or contemporary mathematician each day, with a short factual bio. Curated catalogue, refreshed daily.', '📐',
  'ILM Red Unbound', 'Apache-2.0', 'MathematicianOfDayAddon', 'engagement', ARRAY[]::text[],
  '{}'::jsonb, false, true, true, 'published', 'Shows one mathematician a day from a curated catalogue. Bios are evergreen and factual; an optional AI-written note is generated server-side. No personal data is collected.')
...
WHERE bc.id = :club_id
  AND ar.slug = 'mathematician-of-day'
