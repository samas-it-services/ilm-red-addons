-- Math Puzzle of the Day — reference registration + schema (mirrored from the ilm.red monorepo).
...
VALUES (
  'math-puzzle-of-day', 'Math Puzzle of the Day', '1.0.0', 'A self-contained maths puzzle each day, with a hidden answer and worked solution you can reveal. Curated bank, refreshed daily.', '🧩',
  'ILM Red Unbound', 'Apache-2.0', 'MathPuzzleOfDayAddon', 'engagement', ARRAY[]::text[],
  '{}'::jsonb, false, true, true, 'published', 'Shows one puzzle a day from a curated, human-verified bank. The answer and solution are stored with the puzzle and revealed on click. No personal data is collected.')
...
WHERE bc.id = :club_id
  AND ar.slug = 'math-puzzle-of-day'
